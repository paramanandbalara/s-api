    ...
    content() {
        ...
        <thead>
            <tr>
                ...
                <th style="min-width:80px; text-align:center">Pickup Date</th>
        ...
        for (let i = iterator; i < limit; i++) {
            if(i >= data.length) break;
                ...
                <tr style="height:50px;" >
                    <td align="center">${data[i].pickup_request_no}</td>
                    <td align="center">${dayjs(data[i].pickup_date).format('YYYY-MM-DD')}</td>
                    <td align="center">${data[i].pickup_address}, ${data[i].city}</td>
                    <td align="center">${data[i].contact_name}</td>
                    <td align="center">${data[i].contact_number}</td>
                    <td align="center">${data[i].manifested_orders_count}</td>
